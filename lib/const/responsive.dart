...
extension TextSizeExt on num {
  double get sp => (toDouble() / 390) * AppResponsive.screenHeight;
}
...
extension AppPaddingAndRadius on num {
  ...
  EdgeInsets get hV => EdgeInsets.symmetric(vertical: toDouble(), horizontal: toDouble());
...
extension ColorExt on Color {
  ...
  Color opacity(double percent) => withValues(alpha: percent / 100);
